"""
    This program is a complement to 2D_ANNNI_Cluster.cpp

    It takes data generated by that program, and visualizes the lattice at any snapshot (there is 1
    snapshot per epoch/block), to qualitatively see the time-evolution of the system.
"""
